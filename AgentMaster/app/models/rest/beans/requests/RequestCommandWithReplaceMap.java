 ...
 *
 */
public class RequestCommandWithReplaceMap implements Serializable {
	...
	public void setReplacementVarMap(Map<String, String> replacementVarMap) {
	...
	public RequestCommandWithReplaceMap() {
		super();
	}
